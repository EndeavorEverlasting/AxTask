...
import { buildProductionRecoveryGates, classifyChangedPaths, evaluatePredeployReadiness } from "../../scripts/ai-harness/evaluate-predeploy-readiness.mjs";
...
describe("predeploy readiness evaluator", () => {
  ...
  it("separates application, schema, and deployment configuration impact", () => {
    const impact = classifyChangedPaths(["client/src/App.tsx", "migrations/0043_example.sql", "render.yaml", "docs/README.md"]);
