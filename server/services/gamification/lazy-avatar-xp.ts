...
const GRATITUDE_RE = /\b(thanks|thank you|grateful|gratitude|appreciat|blessed|fortunate|good enough|enough for now)\b/i;
const REST_RE = /\b(rest|breathe|pause|kick back|slow down|unwind|take a break|chill)\b/i;
const PRIORITY_RE = /\b(first|priority|priorit|top of my list|stuck|overwhelm|decide|decision|which should|not sure what|help me choose)\b/i;
