...
/**
 * Verify selected spreadsheet tasks are present after import using the same
 * normalized logical identity parts as import dedupe. Repeated source rows count
 * once because AxTask intentionally stores one logical task and skips repeats.
 */
