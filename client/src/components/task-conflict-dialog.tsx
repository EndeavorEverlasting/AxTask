...
type TaskConflictDialogProps = {
  /** When true, unmount resolves the active queue entry as "aborted" (tests / rare flows). Default: do not abort on unmount. */
 ...
 */
export function TaskConflictDialog(props?: TaskConflictDialogProps) {
  const { abortOnUnmount = false } = props ?? {};
