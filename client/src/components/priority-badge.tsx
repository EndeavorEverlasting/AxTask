...
export function PriorityBadge({ priority, score }: PriorityBadgeProps) {
  ...
  return (
    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium whitespace-nowrap motion-safe:transition-colors motion-safe:duration-300 ${getColorClasses(priority)}`}>
      {priority}
